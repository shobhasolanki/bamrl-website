    ...
    <section id="component-viewer" className=" py-8 sm:py-12">
      <div className="px-4 sm:px-8 md:px-12 max-w-5xl mx-auto">
        ...
        <p className="text-xs sm:text-sm text-muted-foreground mb-8 max-w-lg font-body">
          This is UAV-BRACKET-A7 — a real bracket we optimised for a drone frame. We reduced its weight by 34% while keeping full structural integrity. Drag to rotate and inspect the geometry yourself.
        </p>
      </div>
